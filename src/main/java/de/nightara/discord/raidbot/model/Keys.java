...
public class Keys {
    ...
    public static final ForeignKey<BossRecord, BossRecord> BOSS_BOSS_AFTER_FK = Internal.createForeignKey(Boss.BOSS, DSL.name("boss_boss_after_fk"), new TableField[] { Boss.BOSS.AFTER }, Keys.KEY_BOSS_PRIMARY, new TableField[] { Boss.BOSS.ID }, true, ForeignKeyRule.SET_NULL, ForeignKeyRule.CASCADE);
    ...
    public static final ForeignKey<RoleRecord, BossRecord> ROLE_BOSS_A_FK = Internal.createForeignKey(Role.ROLE, DSL.name("role_boss_a_fk"), new TableField[] { Role.ROLE.BOSS }, Keys.KEY_BOSS_PRIMARY, new TableField[] { Boss.BOSS.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
