...
public class Role extends TableImpl<RoleRecord> {
    ...
    /**
     * The reference instance of <code>raidbot.role</code>
     */
    ...
    /**
     * The column <code>raidbot.role.id</code>.
     */
    public final TableField<RoleRecord, UInteger> ID = createField(DSL.name("id"), SQLDataType.INTEGERUNSIGNED.nullable(false).generatedByDefaultAsIdentity(), this, "");
    ...
    /**
     * Create an aliased <code>raidbot.role</code> table reference
     */
    ...
    /**
     * Create a <code>raidbot.role</code> table reference
     */
    public Role() {
